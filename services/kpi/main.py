...
# Global reusable HTTP client for service-to-service communication
...
async def lifespan(app: FastAPI):
    ...
    logger.info("KPI Microservice client closed.")
...
async def create_kpi(payload: schemas.KPICreate):
    ...
    try:
        ...
        units_res = await http_client.get(f"{ASSET_SERVICE_URL}/units")
        ...
        kpi_res = await http_client.post(
            f"{ASSET_SERVICE_URL}/kpi_records",
